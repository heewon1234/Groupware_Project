					...
					<div class="modal_body_content">
						...
						<div class="modal_body_content_form_plus">
							...
							<div class="modal_body_content_input">
								...
								<div class="modal_body_content_input_right">
									<div class="input-group mb-0">
										<input type="text" name="companyName" class="form-control" placeholder="회사"
											style="font-size: 14px; height: 34px; max-width: 120px; padding: 0 10px;" maxlength="50"
										>
										<input type="text" name="companyRank" class="form-control" placeholder="부서"
											style="font-size: 14px; height: 34px; max-width: 120px; padding: 0 10px; margin: 0 0 0 10px;"
											maxlength="50"
										>
										<input type="text" name="companyDepartment" class="form-control" placeholder="직급"
			...
			<div class="menu_tab">
				...
				<div class="menu_list">
					<div class="menu_list_button">
						...
						<span class="menu_list_button_text">메뉴 이름</span>
					</div>
				...
				<!-- 드롭 다운 메뉴 (리스트 제목에 마우스 올리면 설정 메뉴 나옴) -->
				<div class="menu_list">
				...
				<!-- 일반 메뉴 -->
				<div class="menu_item">
					<img class="menu_item_img" src="/images/commons/body_form/left_item/default/trash.png" /> <span
						class="menu_item_text"
					>휴지통</span>
				</div>
