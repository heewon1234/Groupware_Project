...
<body>
	...
	<div class="body_form">
		...
		<div class="right_item">
			...
			<div class="div">
				<span style="float: right;"><button id="openModalBtn">휴가
						미생성자</button></span>
			</div>
			<c:choose>
					...
					<div id="myModal" class="modal right_item">
						...
						<form action="/works/joindayupdate">
									...
									<c:forEach var="i" items="${list}">
										<tr>
											...
											<td style="text-align: center;"><input type="text"
												name="idList" class="idListbox" hidden> <input
												type="text" name="joindayList" class="joindayListbox" hidden>
							...
							<div style="text-align: center;">
								<button id="leaveCreationForm" type="submit"
									class="button_apply">생성</button>
				...
				<c:otherwise>
					<div id="myModal" class="modal right_item">
						...
						<form action="/works/joindayupdate">
							...
							<div style="text-align: center;">
								<button id="leaveCreationForm" type="submit"
									class="button_apply permit">생성</button>
								<button id="closeModalBtn">취소</button>
							</div>
						</form>
					</div>
