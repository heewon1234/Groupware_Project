...
<body>
	...
	<div class="left_item">
		...
		<div class="menu_tab">
			...
			<!-- 일반 메뉴 -->
			<div class="menu_item">
				<img class="menu_item_img" src="../imges/commons/body_form/left_item/default/information.png" /> <span class="menu_item_text">근무 통계</span>
			</div>
			
			<!-- 일반 메뉴 -->
			<div class="menu_item">
				<img class="menu_item_img" src="../imges/commons/body_form/left_item/default/information.png" /> <span class="menu_item_text">전사 근무관리</span>
			</div>
